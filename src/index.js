  ...
  render() {
    return (
      <div className="footer">
        <h3>
          Created with <a href="https://code.visualstudio.com">VS</a> by{" "}
          <a href="https://github.com/himanshuc3">Himanshu</a> for{" "}
          <a href="https://www.freecodecamp.org/himanshuc3">Freecodecamp</a>
        </h3>
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div className="workspace">
        <h1 id="ex" onClick={this.exampleInput}>
          EX
        </h1>
        <textarea
          ref="textarea"
...
class Colors extends React.Component {
  ...
  render() {
    return (
      <div id="colors">
        <ul>
          <li onClick={this.handleclick} id="theme1" />
          <li onClick={this.handleclick} id="theme2" />
          <li onClick={this.handleclick} id="theme3" />
        </ul>
      </div>
    );
  }
...
// ========================================
ReactDOM.render(<Markdown theme="theme1" />, document.getElementById("root"));
